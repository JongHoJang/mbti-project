...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div className="flex flex-row justify-center gap-20 mt-60">
        <div className="flex-none w-[250px] h-[200px] rounded-lg shadow-md p-12">
          <h4 className="flex justify-center m-30 text-18 font-medium">성격 유형 검사</h4>
